!(function(t, e) {
    ...
    function G(t) {
        ce.isVisible() && et !== t.target.value && ce.resetValidationMessage(),
            (et = t.target.value);
    }
    ...
    var et,
        ...
        .concat(k.icon, " ")
        .concat(B.question, '"></div>\n     <div class="')
        .concat(k.icon, " ")
        .concat(B.warning, '"></div>\n     <div class="')
        .concat(k.icon, " ")
        .concat(B.info, '"></div>\n     <div class="')
        .concat(k.icon, " ")
        .concat(
                ...
                ((function() {
                        ...
                        t &&
                            (t.parentNode.removeChild(t),
                                ot(
                                    [document.documentElement, document.body], [k["no-backdrop"], k["toast-shown"], k["has-column"]]
                                ));
                    })(),
                    X())
            )
        ...
        n &&
            ((function(t, e) {
                    "string" == typeof e
                        ...
                        e ||
                        nt([document.documentElement, document.body], k["no-backdrop"]);
                })(n, e.backdrop), !e.backdrop &&
                e.allowOutsideClick &&
                y(
    ...
    var ht = {
        ...
        yt = {};
    (yt.text = yt.email = yt.password = yt.number = yt.tel = yt.url = function(
        t
    ) {
        var e = it(U(), k.input);
        return (
    ...
    function wt(t, e) {
        ...
        e.html ?
            (tt(e.html, n), T(n, "block")) :
            e.text ?
            ((n.textContent = e.text), T(n, "block")) :
            O(n),
            (function(t, e) {
                for (
    ...
    function Ct(t, i) {
        ...
        T(r), (r.innerHTML = "");
        var a = parseInt(
            null === i.currentProgressStep ? ce.getQueueStep() : i.currentProgressStep
        );
        ...
        b(n, e.customClass, "header"),
            ...
            (function(t, e) {
                ...
                T(n),
                    ...
                    E(n, "width", e.imageWidth),
                    E(n, "height", e.imageHeight),
                    (n.className = k.image),
        ...
        Ot = function() {
            return new Promise(function(t) {
                ...
                (Tt.restoreFocusTimeout = setTimeout(function() {
                    Tt.previousActiveElement && Tt.previousActiveElement.focus ?
                ...
                return (function(t) {
                    ...
                    return (
                        ...
                        r(e, [{
                            key: "_main",
                            value: function(t) {
                                return d(s(e.prototype), "_main", this).call(
                                    this,
                                    a({}, n, t)
                                );
                            }
    ...
    function Zt(t, e, n) {
        e
            ...
            (Ot().then(function() {
                ...
                Tt.keydownTarget.removeEventListener("keydown", Tt.keydownHandler, {
    ...
    function Qt(t) {
        ...
        if (n && !S(n, k.hide)) {
            var o = ht.innerParams.get(this),
                i = Ft.swalPromiseResolve.get(this),
                r = o.onClose,
                a = o.onAfterClose;
            ot(n, k.show),
                nt(n, k.hide),
                dt && j(n) ?
                n.addEventListener(dt, function(t) {
                    t.target === n &&
                        (function(t, e, n, o) {
    ...
    function ne(t) {
        ...
        null !== t.onBeforeOpen &&
            ...
            t.onBeforeOpen(n),
            t.animation && (nt(n, k.show), nt(e, k.fade)),
            T(n),
            dt && j(n) ?
            ((e.style.overflowY = "hidden"),
                n.addEventListener(dt, ee.bind(null, n, e))) :
            (e.style.overflowY = "auto"),
            nt([document.documentElement, document.body, e], k.shown),
            t.heightAuto &&
            t.backdrop &&
            !t.toast &&
            nt([document.documentElement, document.body], k["height-auto"]),
            at() &&
            (t.scrollbarPadding && Rt(),
                (function() {
                    if (
                        /iPad|iPhone|iPod/.test(navigator.userAgent) &&
                        !window.MSStream &&
                        !S(document.body, k.iosfix)
                    ) {
    ...
    var ae,
        se = Object.freeze({
            ...
            _main: function(t) {
                ...
                !(function(t) {
                    for (var e in t)
                        At((i = e)) || y('Unknown parameter "'.concat(i, '"')),
                        t.toast &&
                        ((o = e), -1 !== qt.indexOf(o) &&
                            y(
                                'The parameter "'.concat(o, '" is incompatible with toasts')
                            )),
                        Lt((n = void 0)) && h(n, Lt(n));
                    var n, o, i;
                })(t);
                var l = a({}, Mt, t);
                !(function(e) {
                ...
                return new Promise(function(t) {
                    ...
                    Ft.swalPromiseResolve.set(c, t),
                        l.timer &&
                        (Tt.timeout = new Gt(function() {
                    ...
                    for (
                        var u = function(e) {
                                (l.showLoaderOnConfirm && p.showLoading(), l.preConfirm) ?
                            ...
                            o = d.popup.querySelectorAll("button"),
                            i = 0; i < o.length; i++
                    )
                        (o[i].onclick = e),
                        (o[i].onmouseover = e),
                    ...
                    if (
                        ...
                        (d.container.onmousedown = function() {
                            d.popup.onmouseup = function(t) {
                                ...
                                (t.target !== d.popup && !d.popup.contains(t.target)) ||
                                (r = !0);
                            };
                        }),
                        (d.container.onclick = function(t) {
                            r
                                ?
                                (r = !1) :
                                t.target === d.container &&
                                w(l.allowOutsideClick) &&
                                s(p.DismissReason.backdrop);
                        });
                    }
                    l.reverseButtons ?
                    ...
                    Tt.keydownTarget &&
                        ...
                        ((Tt.keydownHandler = function(t) {
                                return (function(t, e) {
                                    ...
                                    if ("Enter" !== t.key || t.isComposing)
                                        if ("Tab" === t.key) {
                                            for (
                                                var n = t.target, o = J(e.focusCancel), i = -1, r = 0; r < o.length; r++
                                            )
                                                if (n === o[r]) {
                                                    i = r;
                                                    break;
                                            ...
                                            !0 !== w(e.allowEscapeKey) ||
                                            (t.preventDefault(), s(p.DismissReason.esc));
                                    else if (
                                        t.target &&
                                        c.getInput() &&
                                        t.target.outerHTML === c.getInput().outerHTML
                                    ) {
                            ...
                            (Tt.keydownTarget = l.keydownListenerCapture ? window : d.popup),
                            (Tt.keydownListenerCapture = l.keydownListenerCapture),
                            Tt.keydownTarget.addEventListener("keydown", Tt.keydownHandler, {
                                capture: Tt.keydownListenerCapture
                            }),
                        ...
                        c.hideLoading(),
                        c.resetValidationMessage(),
                        l.toast && (l.input || l.footer || l.showCloseButton) ?
                        nt(document.body, k["toast-column"]) :
                        ot(document.body, k["toast-column"]),
                        ...
                        -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(
                            l.input
                        ) &&
                        v(l.inputValue) &&
                        (function(e, n) {
                        ...
                        (w(l.allowEnterKey) ?
                            ...
                            d.cancelButton.focus() :
                            l.focusConfirm && V(d.confirmButton) ?
                            d.confirmButton.focus() :
                            a(-1, 1) :
